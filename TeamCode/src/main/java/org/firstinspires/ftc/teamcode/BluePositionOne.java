...
@Autonomous(name = "BlueDuck" , group = "Main Autons")

public class BluePositionOne extends LinearOpMode {
...
*/
        while(opModeIsActive()) {
            ...
            customaryMove(-49 , -1.0);
            /*
            allMotors.setPower(-0.8);
            sleep(3000);
            allMotors.off();
*/
            encoderTurn(750);
