...
public class MaskPicturePipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        submat1 = new Mat(mask, new Rect(0, 0, input.width()/3, input.height()));
        submat2 = new Mat(mask, new Rect(input.width()/3, 0, input.width()/3, input.height()));
        submat3 = new Mat(mask, new Rect(2 * input.width()/3, 0, input.width()/3, input.height()));
