...
public class OpenCVTest extends LinearOpMode {
    ...
    private double rightBarcodeRangeBoundary = 0.6; //i.e 60% of the way across the frame from the right

    private double lowerRuntime = 0;
    private double upperRuntime = 0;

    //white color range                                 y     cr     cb
    public static Scalar scalarLowerYCrCb = new Scalar(0.0,0.0,0.0);
    public static Scalar scalarUpperYCrCb = new Scalar(0.0,0.0,0.0); //TODO: WHAT ARE THE YCRCB CODES FOR WHITE
